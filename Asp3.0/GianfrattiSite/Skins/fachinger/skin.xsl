...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template name="sitetile_design">
		...
		<table cellpadding="0" cellspacing="0" border="0"><tr><td style="filter:blur(add=0,direction=140,strength=2)"><font face="tahoma" size="6" color="#F8BF24"><xsl:copy-of select="$title" /></font></td></tr></table>
	...
	<xsl:template name="hightlightedtext_design">
		<xsl:param name="text"/>			
			<table bgcolor="#F7EFE6" border="0"><tr><td>
			<!-- start uneditable zone -->
			<xsl:choose>
	...
	<xsl:template name="margin_design">
		...
		<TR valign="bottom" align="center" height="19" bgcolor="#F76B10">
			<td  valign="middle">
		...
		<TD>
			<TABLE border="0" width="100%" cellpadding="1" cellspacing="0" bgcolor="#F76B10">
				<TR>
					<TD width="100%">
						<TABLE width="100%" border="0" cellpadding="4" cellspacing="0" bgcolor="#F7EFE6">
							<TR><TD bgcolor="#F7EFE6" valign="top" width="100%">
	...
	<xsl:template name="rightmargin_design">
		...
		<TABLE border="0" width="171" cellpadding="1" cellspacing="0" bgcolor="#F76B10">
			<TR>
				<TD width="100%">
					<TABLE width="100%" border="0" cellpadding="4" cellspacing="0" bgcolor="#F76B10">
						<TR><TD bgcolor="#F7EFE6" valign="top" width="100%">
							<table cellpadding="3" cellspacing="0">
								<tr>
									<td>
	...
	<xsl:template name="toolbar_global_design">
		<TABLE bgColor="#F76B10" borderColor="#708090" cellSpacing="0" borderColorDark="#00000" cellPadding="" width="100%" borderColorLight="#738494" border="0">
		...
		<TR><TD bgColor="#F76B10" align="center"><table cellpadding="0" cellspacing="0" border="0"><tr><xsl:call-template name="toolbar_body_macro"/></tr></table></TD></TR>
		<TR><TD><img src="skins/iOrange/media/dot.gif" width="1" height="3"/></TD></TR>
	...
	<xsl:template name="toolbar_item_design">
		<xsl:param name="content"/>	
			<td style="width:120px;"><font color="#000000">&#160;
			<!-- start uneditable zone -->
			<xsl:choose>
