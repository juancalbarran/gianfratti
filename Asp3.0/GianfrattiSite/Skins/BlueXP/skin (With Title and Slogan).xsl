...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template name="title_design">
		...
		<TABLE bgColor="#0055D3" borderColor="#95BDEE" cellSpacing="0" borderColorDark="#0055D3" cellPadding="0" width="100%" borderColorLight="#0055D3" border="0">
		<TR><TD bgColor="#0055D3" height="1"><img src="skins/BlueXP/media/dot.gif" width="1" height="1"/></TD></TR>
		<TR><TD><img src="skins/BlueXP/media/dot.gif" width="1" height="1"/></TD></TR>
		...
		<TR><TD><img src="skins/BlueXP/media/dot.gif" width="1" height="1"/></TD></TR>
		<TR><TD bgColor="#0055D3" height="1"><img src="skins/BlueXP/media/dot.gif" width="1" height="1"/></TD></TR></TABLE>			
	</xsl:template>


	<!-- Design of the highlighted text -->
	...
	<xsl:template name="margin_design">
		...
		<TR valign="bottom" align="center" height="19">
			<td bgcolor="#0055D3" bordercolor="#95BDEE" valign="middle">
				<table cellpadding="1" cellspacing="0" border="0"><tr><td style="width:100%;">
		...
		<TD>
			<TABLE border="0" width="100%" cellpadding="1" cellspacing="0" bgcolor="#95BDEE">
				<TR>
					<TD width="100%">
						<TABLE width="100%" border="0" cellpadding="4" cellspacing="0" bgcolor="#95BDEE">
							<TR><TD bgcolor="#D3E5FA" valign="top" width="100%">
	...
	<xsl:template name="gateway_design">
		<table bgcolor="#FFFFF0" width="100%" height="100%">
			<tr>
				<td align="center">
					<!-- start uneditable zone -->
	...
	<xsl:template name="toolbar_global_design">
		<TABLE bgColor="#0055D3" borderColor="#95BDEE" cellSpacing="0" borderColorDark="#00000" cellPadding="0" width="100%" borderColorLight="#0055D3" border="0">
		<TR><TD bgColor="#0055D3" height="1"><img src="skins/BlueXP/media/dot.gif" width="1" height="3"/></TD></TR>
		<TR><TD><img src="skins/BlueXP/media/dot.gif" width="1" height="3"/></TD></TR>
		<TR><TD bgColor="#0055D3" align="center"><table cellpadding="0" cellspacing="0" border="0"><tr><xsl:call-template name="toolbar_body_macro"/></tr></table></TD></TR>
		<TR><TD><img src="skins/BlueXP/media/dot.gif" width="1" height="3"/></TD></TR>
		<TR><TD bgColor="#0055D3" height="1"><img src="skins/BlueXP/media/dot.gif" width="1" height="3"/></TD></TR></TABLE>				
	</xsl:template>	
	...
	<xsl:template name="toolbar_item_design">
		<xsl:param name="content"/>	
			<td style="width:120px;"><font color="#FFFFFF"><xsl:value-of select="$nbsp" disable-output-escaping="yes"/>
			<!-- start uneditable zone -->
			<xsl:choose>
	...
	<xsl:template name="pagetitle_design">
		<xsl:param name="title"/>
			<table><tr><td>
			<font color="#0055D3" size="5" face="verdana">
				<!-- start uneditable zone -->
				<xsl:choose>
					<xsl:when test="contains($title, '&lt;')"><xsl:value-of select="$title" disable-output-escaping="yes"/></xsl:when>
					<xsl:otherwise><xsl:copy-of select="$title" /></xsl:otherwise>
