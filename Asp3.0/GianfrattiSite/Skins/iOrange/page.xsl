...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxml="urn:schemas-microsoft-com:xslt" xmlns:game="urn:schemas-cagle-com:game"    version="1.0" exclude-result-prefixes="msxml game">
	...
	<xsl:param name="toolbar_background">#F8BF24</xsl:param>
	<xsl:param name="toolbar_border"><xsl:value-of select="$body_color"/></xsl:param>

	<!-- Margins skin values -->
	<xsl:param name="margin_background">#FDF8D5</xsl:param>
	...
	<xsl:param name="forum.highlight.row.bgcolor">#FFFFF1</xsl:param>
	...
	<xsl:param name="calendar_tableborder">#F8BF24</xsl:param>
	...
	<xsl:template match="/">
		...
		<HTML dir="{$textdirection}">
			<HEAD>	
				...
				<style>
					...
					A.toolbar:Hover { FONT-WEIGHT: bold; COLOR: #FF6600; TEXT-DECORATION: none; TEXT-TRANSFORM: uppercase;}
					...
					A.link:Hover { COLOR:#ff6600; font-size: 8pt; font-family: tahoma; text-decoration:none}
					A.link	{color:black; font-size: 8pt; font-family: tahoma; text-decoration:none}
		...
		<xsl:choose>
			...
			<xsl:otherwise>
				...
				<body  bgcolor="#FFFFF1" leftmargin="2" topmargin="0" marginwidth="2" marginheight="0"><!-- link="#006600" alink="#006600" vlink="#006600" text="#000000"-->
								
					<!-- START OF THE HEADER -->
					<table border="0" width="100%" cellspacing="0" cellpadding="0" bgcolor="#FFFFF1">
						<tr>
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center" height="100%" bgcolor="#FFFFF1">
						<tr valign="top"  bgcolor="#fffff1">
							<br/>
					    	<xsl:choose>
								...
								<xsl:when test="/siteinfo/pages/page[id=$id]/margintype=1 or string-length(/siteinfo/pages/page[id=$id]/margintype)=0">									 
									...
									<td width="15"><xsl:value-of select="$nbsp" disable-output-escaping="yes"/></td>
							    		<td width="100%" bgcolor="#FFFFF1"><xsl:call-template name="pagetitle_macro"/><xsl:call-template name="pagebody_macro"/></td>
							    </xsl:when>
				...
				<table border="1" bordercolor="000000" cellpadding="0" cellspacing="0" width="100%" align="center">
					<tr> 
						<td bgcolor="#F8BF24" bordercolor="#F8BF24"> 
