...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template name="sitetile_design">
		...
		<table><tr><td style="width:100%; color:#C0C000; filter:dropshadow(color=#000000, offX=1, offY=2)"><font face="arial" size="5" color="#ffffff"><b><i><xsl:copy-of select="$title" /></i></b></font></td></tr></table>

		<!--<font face="verdana" size="5" color="#ffffff"><b><i><xsl:copy-of select="$title" /></i></b></font>-->
	</xsl:template>
	...
	<xsl:template name="pagetitle_design">
		<xsl:param name="title"/>
			...
			<font size="4"><font color="#DFDFDF">::.</font><font color="#201460" >
	...
	<xsl:template name="title_design">
		...
		<TABLE bgColor="#DFDFDF" borderColor="#000000" cellSpacing="0" borderColorDark="#00000" cellPadding="0" width="100%" borderColorLight="#000000" border="0">
		<TR><TD bgColor="#000000" height="1"><img src="skins/thirdeyedmachine/media/dot.gif" width="1" height="1"/></TD></TR>
		<TR><TD><img src="skins/thirdeyedmachine/media/dot.gif" width="1" height="2"/></TD></TR>
		<TR><TD><xsl:value-of select="$nbsp" disable-output-escaping="yes"/><b><font color="ff6600">
			<!-- start uneditable zone -->
			<xsl:choose>
				<xsl:when test="contains($title, '&lt;')"><xsl:value-of select="$title" disable-output-escaping="yes"/></xsl:when>
				<xsl:otherwise><xsl:copy-of select="$title" /></xsl:otherwise>
		...
		<TR><TD><img src="skins/thirdeyedmachine/media/dot.gif" width="1" height="2"/></TD></TR>
		<TR><TD bgColor="#000000" height="1"><img src="skins/thirdeyedmachine/media/dot.gif" width="1" height="1"/></TD></TR></TABLE>			
	</xsl:template>
	...
	<xsl:template name="margin_design">
		...
		<table bgcolor="#000000" border="0" cellpadding="0" cellspacing="0" width="100%">
	        ...
	        <tr>
	        <td width="100%" colspan="2" bgcolor="#DFDFDF">
	        	<!-- start uneditable zone -->
				<xsl:choose>
	...
	<xsl:template name="rightmargin_design">
		...
		<table bgcolor="#FF6600" border="0" cellpadding="0" cellspacing="0" width="100%">
	        <tr> 
	          <td class="rub" width="100%" ><xsl:value-of select="$nbsp" disable-output-escaping="yes"/> <font color="#ffffff"><b>.:<xsl:value-of select="$nbsp" disable-output-escaping="yes"/>
	          	<!-- start uneditable zone -->
				<xsl:choose>
					<xsl:when test="contains($title, '&lt;')"><xsl:value-of select="$title" disable-output-escaping="yes"/></xsl:when>
					<xsl:otherwise><xsl:copy-of select="$title" /></xsl:otherwise>
	...
	<xsl:template name="toolbar_global_design">
		<TABLE bgColor="#DFDFDF" borderColor="#000000" cellSpacing="0" borderColorDark="#00000" cellPadding="0" width="100%" borderColorLight="#000000" border="0">
		<TR><TD bgColor="#000000" height="1"><img src="skins/thirdeyedmachine/media/dot.gif" width="1" height="1"/></TD></TR>
		<TR><TD><img src="skins/thirdeyedmachine/media/dot.gif" width="1" height="4"/></TD></TR>
		<TR><TD bgColor="#DFDFDF"><xsl:value-of select="$nbsp" disable-output-escaping="yes"/><xsl:call-template name="toolbar_body_macro"/></TD></TR>
		<TR><TD><img src="skins/thirdeyedmachine/media/dot.gif" width="1" height="4"/></TD></TR>
		<TR><TD bgColor="#000000" height="1"><img src="skins/thirdeyedmachine/media/dot.gif" width="1" height="1"/></TD></TR></TABLE>				
	</xsl:template>	
