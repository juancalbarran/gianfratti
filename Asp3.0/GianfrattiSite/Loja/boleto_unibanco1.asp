...
cons_carteira = bol_letracarteira
...
if var_intervalo > 5 then
  var_observacoes="<b> <br> Pagamento referente a compra efetuada na loja "&application("nomeloja")&"<br>REIMPRESSÃO DO BOLETO<br> <br></b>"
else
