...
<% if request.querystring("pagina") = "2" then %>
   	  <table><tr><td align="left" valign="top">
	  				 <table border="0" cellspacing="4" cellpadding="4" width=590><tr><td> <font face="<%=fonte%>" style=font-size:11px;color:000000> <a href=default.asp style=text-decoration:none; onMouseOut="window.status='';return true;" onMouseOver="window.status='Home';return true;"><b>Home</b></a> » Como Comprar?<br><br><div align=left> <table border=0 cellspacing=0 width=100% cellpadding=0><tr><td height=5></td></tr><tr><td height=1 bgcolor=<%=cor3%>></td></tr><tr><td height=5></td></tr></table></div><font face="<%=fonte%>" style=font-size:13px><strong><br>Como comprar na <%=nomeloja%></strong></font> - <font face="<%=fonte%>" style=font-size:10px>Página <B>2</B> de <B>3</B> </p><div align=center>
					 		<table align=center width=550 border=0><tr><td valign=center><font face="<%=fonte%>"  style=font-size:11px color=000000><b>Carrinho de Compras (Cont.)</b><br><div align=justify>Além disso, seu carrinho de compras controla todo o seu pedido, clicando sobre os botões: <br><br>&nbsp;&nbsp;&nbsp;&nbsp;<b>»</b> O botão <img src="<%=dirlingua%>/imagens/continuar.gif"> permite acessar a home principal, voltar a navegar pela loja e escolher outros produtos.<br>&nbsp;&nbsp;&nbsp;&nbsp;<b>»</b> O botão <img src="<%=dirlingua%>/imagens/atualiza.gif"> permite visualizar a quantidade correta dos produtos e o real valor a ser pago por cada um caso você tenha alterado a quantidade do produto desejado. <br>&nbsp;&nbsp;&nbsp;&nbsp;<b>»</b> Para remover algum item clique na <img src="<%=dirlingua%>/imagens/del.gif" border="0"> (lixeira) no lado do produto a ser excluido.<br><br>&nbsp;&nbsp;&nbsp;&nbsp;<b>»</b> Selecionando a Forma de Entrega e clique no botão Atualizar. O valor do frete aparecerá calculado abaixo do Total da Compra. <br>Após terminar este procedimento, clique sobre o botão <img src="<%=dirlingua%>/imagens/fecha.gif" border="0">.<br></td></tr>
							<tr><td><font face="<%=fonte%>"  style=font-size:11px color=000000><br><b>Registro de novo cliente (Login)</b><br><br><div align=justify>Ao clicar sobre o botão <i>"Fechar Pedido"</i>", você acessará a página de Login na Loja. <br><br>&nbsp;&nbsp;&nbsp;&nbsp;<b>»</b> Se você já é cliente, apenas coloque seu endereço de E-mail no campo indicado e em seguida informe sua senha cadastrada no site.<br>&nbsp;&nbsp;&nbsp;&nbsp;<b>»</b> Se você ainda não é cliente, clique em <i>"Se é a sua primeira compra nesta loja clique aqui..."</i>.<br>&nbsp;&nbsp;&nbsp;&nbsp;<b>»</b> Preencha corretamente os campos do formulário nesta página. A partir de então, você terá um cadastro na <%=nomeloja%> e ao clicar no botão <img src="<%=dirlingua%>/imagens/prosseguir.gif" border="0">, você acessa a página de Fechamento de Pedido.</ul>Após confirmar todas as informações digitadas, clique novamente sobre o botão <img src="<%=dirlingua%>/imagens/fecha.gif" border="0"> ou <img src="<%=dirlingua%>/imagens/prosseguir.gif" border="0">.</td></tr>
...
<%else%>
		<table><tr><td align="left" valign="top">
					   <table border="0" cellspacing="4" cellpadding="4" width=590>
						...
						<tr><td><font face="<%=fonte%>"  style=font-size:11px color=000000><b>Escolha do produto</b><br><div align=justify>&nbsp;&nbsp;&nbsp;Ao encontrar o produto desejado, clique sobre <img src="<%=dirlingua%>/imagens/detalhes.gif"  border="0"> para obter mais informações e caso queira comprá-lo basta escolher a quantidade do item escolhido e clicar em <i>"Comprar Produto"</i>.</td>
						<tr><td><center><img src="<%=dirlingua%>/imagens/default_como.gif" border="0"></center></td></tr><tr><td><font face="<%=fonte%>"  style=font-size:11px color=000000><b>Carrinho de Compras</b><br><div align=justify>&nbsp;&nbsp;&nbsp;Ao clicar sobre o botão <img src="<%=dirlingua%>/imagens/comprar.gif"  border="0">, você coloca o produto escolhido em seu <i>"Carrinho de Compras"</i>, que mostra todas as informações sobre sua compra. Nele você obtém todas as informações sobre o(s) produto(s) adquiridos.</td></tr>
