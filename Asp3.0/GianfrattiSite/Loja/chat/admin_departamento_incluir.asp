...
If Not IsEmpty(Request.Form) Then
  ...
  If campo_duplicado = false Then
    ...
    objRS.CursorType = 0
    objRS.LockType = 3
    strQ = "SELECT * FROM departamentos Where 1 <> 1"
    ...
    Set objRS = Nothing
%>
<B><font color="#CC0000">Novo departamento criado</font></B><BR>
O novo departamento foi criado com sucesso.<BR>
<BR>
<%
  Else
%>
...
Else
  ...
  objRS.Open strQ, objCon, , , &H0001
%>
<B><font color="#CC0000">Incluir Departamento</font></B><BR>
Informe abaixo o t&iacute;tulo do departamento:<BR>
...
<%If objRS.Fields("departamento").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="departamento" maxlength="255" value="" onKeyPress="desabilita_cor(this)"  df_verificar="sim" class=campos_formulario>
<%
Else
