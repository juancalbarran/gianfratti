                    ...
                    <tr>
                      <td align="left" height="100%" vAlign="top" width="65%">
                        <table border="0" width="100%">
                          <tr>
                            <td width="50%" valign="middle" align="left"><font color="#aa3333" face="Arial, Geneva, Helvetica, Verdana" size="4"><b>Atenção: Excluir banner
                              <%=oRS("name").Value%> 
                              ??</b></font>
                            </td>
                        ...
                        <p align="center"><br>
                        Você solicitou a exclusão do banner <%=oRS("name").Value%>. Você tem certeza? Esta ação <b>não</b> poderá ser desfeita e serão excluídas todas as estatísticas deste banner.<br>
                        <br>
                        <%WriteFakeButton "deleteabanner.asp?id=" & oRS("bannerid").Value & "&del=yes", "Sim, tenho certeza" %>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <%WriteFakeButton "showdetails.asp?id=" & oRS("bannerid").Value , "Não!" 
                        %>
                        </td></tr></table>
                        </td></tr></table>
