                    ...
                    <tr>
                      <td align="left" height="100%" vAlign="top">
                        <table border="0" width="100%">
                          <tr>
                            <td width="50%" valign="middle" align="left"><font color="#aa3333" face="Arial, Geneva, Helvetica, Verdana" size="4"><b>Stat
                              filter:</b></font>
                            </td>
                      ...
                      <%AdAdminWriteMenu%>
                            ...
                            <td>
                              <form method="POST" action="statsres.asp">
                                ...
                                <table border="0" width="100%" cellpadding="2" cellspacing="0" bgcolor="#ffffff">
                                  <tr>
                                    <td width="29%"><b>Tipos (tamanho)</b>:</td>
                                  ...
                                  <tr>
                                    ...
                                    <td width="61%"><input type="checkbox" name="HTMLBanner" value="ON" checked>Código
                                      HTML <br>
                                      <input type="checkbox" name="RegularBanner" value="ON" checked>Banners
                                      com imagem
                                    </td>
                                  </tr>
                                </table>
