...
function ColorPicker() {
	...
	var colors = new Array("#000000","#000033","#000066","#000099","#0000CC","#0000FF","#330000","#330033","#330066","#330099","#3300CC",
							...
							"#CCFFFF","#FFFF00","#FFFF33","#FFFF66","#FFFF99","#FFFFCC","#FFFFFF","#111111","#222222","#333333","#444444",
							"#555555","#666666","#777777","#888888","#999999","#AAAAAA","#BBBBBB","#CCCCCC","#DDDDDD","#EEEEEE","#FFFFFF");
	...
	if (windowMode) {
		...
		cp_contents += "<BODY  leftmargin=0 topmargin=0 rightmargin=0 bottommargin=0 marginwidth=0 marginheight=0><CENTER>";
		}
	cp_contents += "<TABLE BORDER=0 BGCOLOR='#F0F0F0' CELLSPACING=1 CELLPADDING=0 style=\"border: 2px black dashed;\">";
