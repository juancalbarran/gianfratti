...
this.imgURL = _editor_url + '../Shared/htmlarea/images/';
this.debug  = 0;
...
function editor_action(button_id) {
  ...
  // help popup
  if (cmdID == 'showhelp') {
    window.open(_editor_url + "../Shared/htmlarea/popups/editor_help.html", 'EditorHelp',
  ...
  if (cmdID == 'popupeditor') {
    window.open(_editor_url + "../Shared/htmlarea/popups/fullscreen.html?"+objname,
                'FullScreen',
                'toolbar=no,location=no,directories=no,status=yes,menubar=no,scrollbars=yes,resizable=yes');
    return;
  }
...
// If you don't wan't the Find-function to work in HTML-mode, see http://www.interactivetools.com/forum/forum.cgi?post=12934
  if (cmdID == 'Find') {
     ...
     showModelessDialog(_editor_url + "../Shared/htmlarea/popups/find.html",window, "resizable: no; help: no; status: no; scroll: no; ");
     return;
  }
// end insert by lvn  
...
// inserted by lvn
  ...
  // special characters
    ...
    var newchar = showModalDialog(_editor_url + "../Shared/htmlarea/popups/insert_char.html", '', "dialogWidth:493px; dialogHeight: 140px; resizable: no; help: no; status: no; scroll: no;");
    if (newchar == '') {
       return;
    } else {
...
// end insert by lvn
  ...
  // fgColor and bgColor
    ...
    var newcolor = showModalDialog(_editor_url + "../Shared/htmlarea/popups/select_color.html", oldcolor, "resizable: no; help: no; status: no; scroll: no;");
  ...
  // commandID and pass it to execCommand().   See http://msdn.microsoft.com/workshop/author/dhtml/reference/commandids.asp
	...
	var myText = showModalDialog(_editor_url + "../Shared/htmlarea/popups/insert_easylink.html", editdoc, "resizable: no; help:no; status: no; scroll: no; ");
	if (myText) {
...
showModalDialog(_editor_url + "../Shared/htmlarea/popups/insert_image.html", editdoc, "resizable: no; help:no; status: no; scroll: no; ");
    }

// insert image 2 (For Fullxml regular users)
else if (cmdID.toLowerCase() == 'insertimage2'){
showModalDialog(_editor_url + "../Shared/htmlarea/popups/insert_image2.html", editdoc, "resizable: no; help:no; status: no; scroll: no; ");
    }
	

// insert form
  else if (cmdID.toLowerCase() == 'inputform') {
	var myText = showModalDialog(_editor_url + "../Shared/htmlarea/popups/insert_form.html","","resizable: no; help: no; status: no; scroll: no; ");
	if (myText) {
		editor_insertHTML(objname, unescape( myText) );
	}
  }
...
// insert formelement 
		...
		var myText = showModalDialog(_editor_url + "../Shared/htmlarea/popups/insert_formelement.html",
									highlightedText,
    ...
    // insert table
      ...
      setGlobalVar('_editor_field',objname);
      showModalDialog(_editor_url + "../Shared/htmlarea/popups/insert_table.html?"+objname,
                                 window,
...
// insert line
    ...
    setGlobalVar('_editor_field',objname);
    var myText = showModalDialog(_editor_url + "../Shared/htmlarea/popups/insert_line.html",
                                 window,
                                 "resizable: yes; help: no; status: no; scroll: no; ");
...
// Change Case
	...
	var myText = showModalDialog(_editor_url + "../Shared/htmlarea/popups/changecase.html",
...
// insert marquee
   ...
   var myTitle = "";
    var myText = showModalDialog(_editor_url + "../Shared/htmlarea/popups/insert_marquee.html",
...
// Insert anchor
   ...
   var myTitle = "";
    var myText = showModalDialog(_editor_url + "../Shared/htmlarea/popups/insert_anchor.html",
                                 myTitle,      // str or obj specified here can be read from dialog as "window.dialogArguments"
                                 "resizable: yes; help: no; status: no; scroll: no; ");
    if (myText) { editor_insertHTML(objname, unescape( myText) ); }
  }
...
// inserted by lvn : property pallettes
           case 'TableProperties'    : nullBorders(editor_obj.contentWindow.document,'hide'); 
                                       ...
                                       showModalDialog(_editor_url + "../Shared/htmlarea/popups/tableprop.html?"+objname,
                                                       window,
                                                       "resizable: yes; help: no; status: no; scroll: no; ");
                                       td.focus();
                                       break;
           case 'RowProperties'      : setGlobalVar('_editor_field',objname);
                                       ...
                                       showModalDialog(_editor_url + "../Shared/htmlarea/popups/rowprop.html?"+objname,
                                                       window,
                                                       "resizable: yes; help: no; status: no; scroll: no; ");
                                       td.focus();
                                       break;
           case 'CellProperties'     : setGlobalVar('_editor_field',objname);
                                       ...
                                       showModalDialog(_editor_url + "../Shared/htmlarea/popups/cellprop.html?"+objname,
                                                       window,
                                                       "resizable: yes; help: no; status: no; scroll: no; ");
                                       td.focus();
                                       break;
...
function editor_setmode(objname, mode) {
 ...
 // src="' +_editor_url+ '../Shared/htmlarea/popups/blank.html"
...
function editor_about(objname) {
  showModalDialog(_editor_url + "../Shared/htmlarea/popups/about.html", window, "resizable: yes; help: no; status: no; scroll: no; ");
}
