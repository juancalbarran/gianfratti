...
<div style="height:20px; width:100%; backGround-color:#FFFFE1; border:1px solid #666666; font-family:tahoma; font-size:10px; padding-left:10px; padding-top:2px; text-transform:uppercase; display:none;" id="Alerta"><img src="../shared/img/icones/atencao.gif" hspace="10"><span id="pisca" style="color:#FF0000;">O cancelamento desta ação poderá ocasionar perca de informações!</span></div>
