...
function ValidarDataExpReg(pStr, pFmt)
{
	...
	if (reDate.test(pStr)) {
		...
		alert(pStr + " nao e um formato de data valido.\n\nExemplo: dd/mm/aaaa");
	}
}
...
function ValidarHoraExpReg(pStr, pFmt)
{
	...
	if (reTime.test(pStr)) {
		...
		alert(pStr + " nao e um formato de horario valido. \n\nExemplo: HH:MM - 12:45");
	}
} 

//Função que valida a data, verifica tb se o mes de janeiro
// para usar onBlur="ValidarData(NomeCampo); return false;"	
