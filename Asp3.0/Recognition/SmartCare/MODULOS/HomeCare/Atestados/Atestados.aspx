<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Atestados.aspx.vb" Inherits="SmartCare.Atestados1"%>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			&nbsp;
			<FIELDSET id="FIELDSET1" style="WIDTH: 100%; HEIGHT: 30px"><LEGEND id="LEGEND1" align="center" runat="server">&nbsp;Atestados&nbsp;</LEGEND>
					...
					<TR>
						<TD colSpan="3">
							...
							<table width="100%">
								...
								<tr class="zebra_orange1">
									<td class="texto" colSpan="6" vAlign="top" height="410">
										<asp:label id="Lbl_Texto" runat="server"></asp:label></td>
								</tr>
							</table>
							<table width="100%">
								<tr class="zebra_orange1">
							...
							<table width="100%">
								<tr class="zebra_orange1">
									<td class="texto" align="center"><asp:button id="Btn_Voltar" runat="server" Text="Voltar"></asp:button>&nbsp;<INPUT onclick="javascript:Imprimir()" type="button" value="Imprimir">&nbsp;&nbsp;&nbsp;</td>
								</tr>
							</table>
						</TD>
					</TR>
