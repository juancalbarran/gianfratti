<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Receituario.aspx.vb" Inherits="SmartCare.Receituario"%>
...
<HTML>
	...
	<body>
		<form id="Form" method="post" runat="server">
			<FIELDSET><LEGEND id="LEGEND1" align="center" runat="server">&nbsp;Receituário Médico&nbsp;</LEGEND>
				<table width="100%">
				...
				<table width="100%">
					<tr class="zebra_orange1">
						<td class="texto" align="center"><asp:button id="Btn_Gravar" runat="server" Text="Gravar Receituario"></asp:button></td>
					</tr>
				</table>
			</FIELDSET>
			<asp:RequiredFieldValidator id="RequiredFieldValidator1" runat="server" ErrorMessage="Entre com o texto do receituário"
