...
Function Conteudos
	...
	SQL	=	"SELECT CONTEUDOS.id_Conteudo, CONTEUDOS.id_Pagina, CONTEUDOS.id_pagina, CONTEUDOS.Conteudo_Titulo, CONTEUDOS.Conteudo " &_ 
			"FROM CONTEUDOS " &_ 
			"Where Conteudo_Flag_Publicado = True And id_conteudo = "&Cint(Request("id_Conteudo"))&" "
                                  ...
                                  "<td colspan='2' background='img/certific.jpg'> "& Chr(10) &_  
                                    "<table width='100%' border='0' cellspacing='0' cellpadding='0'> "& Chr(10) &_ 
                                      "<tr>" & Chr(10) &_  
                                        ...
                                        "<td width='326'><font color='#666666'>&nbsp;</font><b><font color='#004890'>"&Rs("Conteudo_Titulo")&"</font></b></td> "& Chr(10) &_ 
                                      "</tr>"& Chr(10) &_ 
                                    "</table>"& Chr(10) &_ 
									"</td> "& Chr(10) &_ 
                                "</tr>"& Chr(10) &_ 
                ...
                <td width="571" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      ...
                      <td width="97%" valign="top"> <%=Conteudos%></td>
                    </tr>
                    <tr> 
                      <td colspan="2">&nbsp; </td>
                    </tr>
