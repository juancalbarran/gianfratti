...
//************************************************************
//http://www.codigofonte.com.br/codigos/js-dhtml/validacao
//Validação de campos textos com preenchimento Obrigatorio
//Colocar tag no form form: onSubmit="return ValidaSemPreenchimento(this)"
//Ex: <input name="texto" type="text" Obrigatorio="1" AliasCampo="Nome">
//************************************************************
function ValidaTexto(form)
{
...
function AbrePopUp(Link_Pagina,Largura,Altura) 
	{
	   window.open(Link_Pagina,'','width='+Largura+',height='+Altura+',resizable=yes,scrollbars=yes,top=0,left=0,screenX=800,screenY=600,status=yes')
	}
...
//Função para abrir uma janela popup do Tipo Modal
...
//Função responsavem por pegar as variaveis da querystring do navegador
//Exempo de como usar:
/*
...
<a href="Request.htm?var1=primeira&var2=segunda&var3=terceira">link</a>
*/
function QueryString(variavel){
	qs=new Array()
	variaveis=top.location.search.replace(/\x3F/,"").replace(/\x2B/g," ").split("&")
...
function RedimensionaIframe(nome)
	{
		var altura = eval("document.frames[nome].document.body.scrollHeight");
        eval("document.getElementById(nome).style.height = altura");
    }
