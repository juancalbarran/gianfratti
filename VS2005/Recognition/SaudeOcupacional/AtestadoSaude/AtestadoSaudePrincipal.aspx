<%@ Page Language="C#" MasterPageFile="~/Template/TemplateEmpresa.master" AutoEventWireup="true" CodeFile="AtestadoSaudePrincipal.aspx.cs" Inherits="AtestadoSaude_AtestadoSaudePrincipal" Title="Untitled Page" %>

<%@ Register Src="../UserControls/DropDownList/Cliente.ascx" TagName="Cliente" TagPrefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<fieldset style="height: 100%">
<legend  align=center >&nbsp;Gerenciador de Atestados de Saúde (ASO)&nbsp;</legend>
<fieldset>
<legend  align=left >&nbsp;Busca&nbsp;</legend>
    <table class=texto style="width: 100%; height: 100%" border="0" cellpadding="0" cellspacing="1">
        ...
        <tr>
            ...
            <td style="width: 100px; height: 21px;">
                <asp:TextBox ID="TxtCPF" runat="server" MaxLength="12" onKeyPress="return MascaraCampo(this.form.name, this, '999999999-99', event);" ></asp:TextBox></td>
            <td style="width: 100px; height: 21px;">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
        ...
        DataKeyNames="ID" Width="100%" OnPreRender="GridView1_PreRender" AllowPaging="True" PageSize="15" OnPageIndexChanging="GridView1_PageIndexChanging">
        ...
        <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="DefaultAbas.aspx?idFuncionario={0}"
