<%@ Page Language="C#" MasterPageFile="~/Template/TemplateEmpresa.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Guias_SolicitacaoInternacao_Default" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<fieldset>
<legend>Gerenciador de Guias de Solicitações de Internações</legend>
<fieldset>
<legend>Busca</legend>
<table style="width:100%;" class="texto" >
    <tr>
        <td>Nome beneficiário:</td>
        <td>Nº Registro ANS:</td>
...
<asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Template/Img/botao_cadastro.gif" PostBackUrl="~/Guias/SolicitacaoInternacao/GuiaSolicitacaoInternacaoCadastro.aspx" />
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server"
        SelectMethod="SelectAll" TypeName="TissObjetos.GuiaSolicitacaoInternacaoDAL" DeleteMethod="Delete">
        <SelectParameters>
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="GuiaSolicitacaoInternacaoCadastro.aspx?ID={0}"
