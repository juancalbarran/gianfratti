<%@ Page Language="C#" MasterPageFile="~/Template/TemplateEmpresa.master" AutoEventWireup="true" CodeFile="EvolucaoMedicaPrincipal.aspx.cs" Inherits="EvolucaoMedica_EvolucaoMedicaPrincipal" Title="SmartCare - Hospital do Rim" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">  
   <fieldset>
    <legend align="center">Gerenciador de Evolução Médica</legend>
    <fieldset>
    ...
    <fieldset>
      ...
      <table class="texto" width="100%" border="1" cellpadding="0" cellspacing="0" rules="all" id="ctl00_ContentPlaceHolder1_GridView1">
        <tr bgcolor="#F3F7FC">
            ...
            <td style="font-weight: bold; color: black; width: 208px;">Data</td>
            <td style="width: 17px">
                &nbsp;</td>
	    </tr>        
	    <tr>
          ...
          <td style="width: 208px">
              22/11/2007</td>
          <td style="width: 17px"><a href="../EvolucaoMedica/EvolucaoMedicaPreenchido.aspx"><asp:Image  ID="Image1" runat="server" ImageUrl="~/Template/Img/alterar.gif" /></a></td>
        </tr>        
        <tr>
          <td>
              Maria da Silva</td>
          ...
          <td style="width: 208px">
              20/11/2007</td>
          <td style="width: 17px"><a href="../EvolucaoMedica/EvolucaoMedicaPreenchido2.aspx"><asp:Image  ID="Image2" runat="server" ImageUrl="~/Template/Img/alterar.gif" /></a></td>
        </tr>
        <tr>
          <td></td>
          <td></td>
	...
	<fieldset>
		<table class="texto" width="100%" border="0" cellpadding="0" cellspacing="0">
		  <tr>
		    <td align="center" style="height: 24px"><asp:Button ID="Button1" runat="server" PostBackUrl="~/EvolucaoMedica/EvolucaoMedica.aspx" Text="Cadastrar" /></td>
          </tr>
       </table>
	  </fieldset>
