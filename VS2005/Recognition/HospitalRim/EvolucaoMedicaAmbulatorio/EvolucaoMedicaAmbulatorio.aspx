<%@ Page Language="C#" MasterPageFile="~/Template/TemplateEmpresa.master" AutoEventWireup="true" CodeFile="EvolucaoMedicaAmbulatorio.aspx.cs" Inherits="EvolucaoMedicaAmbulatorio_EvolucaoMedicaAmbulatorio" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	<fieldset>
		<legend align="center">Evolução Médica Ambulatorial</legend>
<fieldset>
  ...
  <table class="texto" width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<fieldset>
    	    ...
    	    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="texto">
				<tr>
				  <td colspan="2"><textarea name="textarea" id="Textarea2" style="width: 100%; height: 380px"></textarea></td>
				</tr>
				<tr>
				  <td colspan="2">
                      CID 10:</td>
				...
				<tr>
				    <td style="width: 64px">
                        <asp:TextBox ID="TextBox1" runat="server" Width="57px"></asp:TextBox></td>
				    <td>
                        <asp:TextBox ID="TextBox2" runat="server" Width="538px"></asp:TextBox></td>
				</tr>
			</table>
		</fieldset>
		<fieldset>
