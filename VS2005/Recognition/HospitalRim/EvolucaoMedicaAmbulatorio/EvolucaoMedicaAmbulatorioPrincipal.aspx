<%@ Page Language="C#" MasterPageFile="~/Template/TemplateEmpresa.master" AutoEventWireup="true" CodeFile="EvolucaoMedicaAmbulatorioPrincipal.aspx.cs" Inherits="EvolucaoMedicaAmbulatorio_EvolucaoMedicaAmbulatorioPrincipal" Title="Untitled Page" %>
   ...
   <fieldset>
    ...
    <fieldset>
      ...
      <table class="texto" width="100%" border="1" cellpadding="0" cellspacing="0" rules="all" id="ctl00_ContentPlaceHolder1_GridView1">
	    ...
	    <tr>
          <td>NANANANANANANANANANANA</td>
          <td>NANANANANA</td>
          <td>NANANANANANA</td>
          <td style="width: 208px">NANANANA</td>
          <td style="width: 17px"><a href="../EvolucaoMedicaAmbulatorio/EvolucaoMedicaAmbulatorioPreenchido.aspx"><asp:Image  ID="Image1" runat="server" ImageUrl="~/Template/Img/alterar.gif" /></a></td>
        </tr>        
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
	...
	<fieldset>
		<table class="texto" width="100%" border="0" cellpadding="0" cellspacing="0">
		  <tr>
		    <td align="center" style="height: 24px"><asp:Button ID="Button1" runat="server" PostBackUrl="~/EvolucaoMedicaAmbulatorio/EvolucaoMedicaAmbulatorio.aspx" Text="Cadastrar" /></td>
          </tr>
       </table>
	  </fieldset>
