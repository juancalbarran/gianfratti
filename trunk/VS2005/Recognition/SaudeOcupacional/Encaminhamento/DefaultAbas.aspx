<%@ Page Language="C#" MasterPageFile="~/Template/TemplateEmpresa.master" AutoEventWireup="true" CodeFile="DefaultAbas.aspx.cs" Inherits="Encaminhamento_DefaultAbas" Title="Untitled Page" %>
...
<script type="text/javascript" language="JavaScript">
    ...
    {
        if(TIPO == 1)
            document.getElementById('div_Aba1').src="EncaminhamentoFuncionario.aspx";
        else if(TIPO == 2)
            document.getElementById('div_Aba2').src="EncaminhamentoCandidato.aspx";
    }
</script>
<!-- FIM DO JAVA SCRIPT -->
</head>
...
<table cellspacing="0" cellpadding="0" border="0"  style="border-left: 1px solid #000000; width: 100%; height: 15px">
	<tr>
	    <!-- PRIMEIRA ABA -->  
		<td id="td_Aba1" onclick="AlternarAbas('td_Aba1','div_Aba1'); Link(1);" style="border-bottom: 0px solid #000000;width: 140; height:20">
			<a href="#" style="color: #000000;">Encaminhar Funcionário</a>
		</td>
		<!-- SEGUNDA ABA -->  
		<td  id="td_Aba2" onclick="AlternarAbas('td_Aba2','div_Aba2'); Link(2);" style="border-bottom: 0px solid #000000;width: 130; height:20">
			<a href="#" style="color: #000000;">Encaminhar Candidato</a>
		</td>
