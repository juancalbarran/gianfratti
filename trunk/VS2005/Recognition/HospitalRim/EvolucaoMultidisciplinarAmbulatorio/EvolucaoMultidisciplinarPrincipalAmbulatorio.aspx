<%@ Page Language="C#" MasterPageFile="~/Template/TemplateEmpresa.master" AutoEventWireup="true" CodeFile="EvolucaoMultidisciplinarPrincipalAmbulatorio.aspx.cs" Inherits="EvolucaoMultidisciplinarAmbulatorio_EvolucaoMultidisciplinarPrincipalAmbulatorio" Title="SmartCare - Hospital do Rim" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  <fieldset>
    <legend align="center">Gerenciador de Evolução Multidisciplinar</legend>
    <fieldset>
    ...
    <fieldset>
      ...
      <table class="texto" width="100%" border="1" cellpadding="0" cellspacing="0" rules="all" id="ctl00_ContentPlaceHolder1_GridView1">
	    ...
	    <tr>
          ...
          <td>
              NANANA</td>
          <td style="width: 20px"><a href="EvolucaoMultidisciplinarAmbulatorioPreenchido.aspx"><asp:Image  ID="Image1" runat="server" ImageUrl="~/Template/Img/alterar.gif" /></a></td>
        </tr>        
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
	  ...
	  <fieldset>
		<table class="texto" width="100%" border="0" cellpadding="0" cellspacing="0">
		  <tr>
		    <td align="center" style="height: 24px"><asp:Button ID="Button1" runat="server" PostBackUrl="~/EvolucaoMultidisciplinarAmbulatorio/EvolucaoMultidisciplinarAmbulatorio.aspx" Text="Cadastrar" /></td>
          </tr>
       </table>
	  </fieldset>
    </fieldset>
