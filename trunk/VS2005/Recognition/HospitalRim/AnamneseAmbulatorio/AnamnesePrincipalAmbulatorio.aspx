<%@ Page Language="C#" MasterPageFile="~/Template/TemplateEmpresa.master" AutoEventWireup="true" CodeFile="AnamnesePrincipalAmbulatorio.aspx.cs" Inherits="AnamneseAmbulatorio_AnamnesePrincipalAmbulatorio" Title="SmartCare - Hospital do Rim" %>
  ...
  <fieldset>
    ...
    <fieldset>
      ...
      <table class="texto" width="100%" border="1" cellpadding="0" cellspacing="0" rules="all" id="ctl00_ContentPlaceHolder1_GridView1">
        <tr bgcolor="#F3F7FC">
            <td style="font-weight: bold; color: black; width: 320px;">Nome:</td>
            <td style="font-weight: bold; color: black; width: 110px;">Registro Geral</td>
            <td style="font-weight: bold; color: black; width: 161px;">Tipo de Atendimento</td>
            <td style="font-weight: bold; color: black; width: 108px;">Data</td>
            <td style="width: 10px"></td>
	    </tr>
        <tr>
          <td style="width: 320px">
              NANANANANANANA NANANA</td>
          ...
          <td style="width: 108px">
              NANANAA</td>
          <td style="width: 10px"><a href="FormAnamneseAmbulatorialPreenchido.aspx"><asp:Image  ID="Image1" runat="server" ImageUrl="~/Template/Img/alterar.gif" /></a></td>
        </tr>        
        <tr>
		...
		<table class="texto" width="100%" border="0" cellpadding="0" cellspacing="0">
		  <tr>
		    <td align="center" style="height: 24px">
                <asp:Button ID="Button1" runat="server" PostBackUrl="~/AnamneseAmbulatorio/FormAnamneseExameFisicoAmbulatorio.aspx" Text="Cadastrar" /></td>
          </tr>
       </table>
	  </fieldset>
    </fieldset>
