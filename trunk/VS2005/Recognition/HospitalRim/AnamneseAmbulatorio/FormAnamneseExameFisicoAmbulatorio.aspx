<%@ Page Language="C#" MasterPageFile="~/Template/TemplateEmpresa.master" AutoEventWireup="true" CodeFile="FormAnamneseExameFisicoAmbulatorio.aspx.cs" Inherits="AnamneseAmbulatorio_FormAnamneseExameFisicoAmbulatorio" Title="SmartCare - Hospital do Rim" %>
  ...
  <table class="texto" width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <fieldset>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="texto">
            ...
            <tr>
                ...
                <td><input id="Text5" style="width: 175px" type="text" /></td>
            </tr>
            <tr>
                <td><input id="Text2" style="width: 395px" type="text" /></td>
                <td><input id="Text6" style="width: 175px" type="text" /></td>
            </tr> 
            <tr>
      ...
      <fieldset>
        ...
        <table class="texto" width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td style="height: 24px"><textarea id="Textarea2" style="width: 100%; height: 99px"></textarea></td>
          </tr>
        </table>
      </fieldset>
      ...
      <fieldset>
        ...
        <table class="texto" width="100%" border="0" cellpadding="0" cellspacing="0">
           <tr>
            <td><textarea id="Textarea7" style="width: 100%; height: 37px;"></textarea></td>
          </tr>
        </table>
      </fieldset>
      ...
      <fieldset>
        ...
        <table class="texto" width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
	        <td><textarea id="Textarea4" style="width: 100%; height: 39px;"></textarea></td>
          </tr>
        </table>
      </fieldset>
      ...
      <fieldset>
        ...
        <table class="texto" width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td><textarea id="Textarea5" style="width: 100%; height: 40px;"></textarea></td>
          </tr>
        </table>
      </fieldset>
...
<fieldset>
        ...
        <table class="texto" width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td width="3%">1.</td>
            <td width="8%">CID10:</td>
            <td width="8%"><input name="textfield2022" type="text" style="width: 50px" /></td>
          ...
          <tr>
            <td>2.</td>
            <td>CID10:</td>
            <td><input name="textfield20222" type="text" style="width: 50px" /></td>
          ...
          <tr>
            <td>3.</td>
            <td>CID10:</td>
            <td><input name="textfield20223" type="text" style="width: 50px" /></td>
            <td><input name="textfield202" type="text" style="width: 265px" /></td>
            <td>
                3.</td>
            <td>CID10:</td>
          ...
          <tr>
            <td>4.</td>
            <td>CID10:</td>
            <td><input name="textfield20224" type="text" style="width: 50px" /></td>
            <td><input name="textfield202" type="text" style="width: 265px" /></td>
            <td>
                4.</td>
            <td>
