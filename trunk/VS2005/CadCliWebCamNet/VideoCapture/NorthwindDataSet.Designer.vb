...
Partial Public Class NorthwindDataSet
    ...
    Partial Public Class EmployeesDataTable
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddEmployeesRow(ByVal LastName As String, ByVal FirstName As String, ByVal Title As String, ByVal Photo() As Byte) As EmployeesRow
            Dim rowEmployeesRow As EmployeesRow = CType(Me.NewRow,EmployeesRow)
            rowEmployeesRow.ItemArray = New Object() {Nothing, LastName, FirstName, Title, Photo}
...
Namespace NorthwindDataSetTableAdapters
    ...
    Partial Public Class EmployeesTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employees] ([LastName], [FirstName], [Title], [Photo]) VALUES "& _ 
                "(@LastName, @FirstName, @Title, @Photo);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT EmployeeID, LastName, FirstName"& _ 
                ", Title, Photo FROM Employees WHERE (EmployeeID = SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Employees] SET [LastName] = @LastName, [FirstName] = @FirstName, [T"& _ 
                "itle] = @Title, [Photo] = @Photo WHERE (([EmployeeID] = @Original_EmployeeID) AN"& _ 
                "D ([LastName] = @Original_LastName) AND ([FirstName] = @Original_FirstName) AND "& _ 
                "((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Original_Title)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELE"& _ 
                "CT EmployeeID, LastName, FirstName, Title, Photo FROM Employees WHERE (EmployeeI"& _ 
                "D = @EmployeeID)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.VideoCapture.My.MySettings.Default.NorthwindConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT EmployeeID, LastName, FirstName, Title, Photo FROM dbo.Employees"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_EmployeeID As Integer, ByVal Original_LastName As String, ByVal Original_FirstName As String, ByVal Original_Title As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal LastName As String, ByVal FirstName As String, ByVal Title As String, ByVal Photo() As Byte) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal LastName As String, ByVal FirstName As String, ByVal Title As String, ByVal Photo() As Byte, ByVal Original_EmployeeID As Integer, ByVal Original_LastName As String, ByVal Original_FirstName As String, ByVal Original_Title As String, ByVal EmployeeID As Integer) As Integer
            If (LastName Is Nothing) Then
                Throw New System.ArgumentNullException("LastName")
            Else
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(9).Value = CType(EmployeeID,Integer)
