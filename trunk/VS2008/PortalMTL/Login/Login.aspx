<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="PortalMTL.Login.Login" %>
<html>
	...
	<tr>
		<td align="center" valign="middle">
			<table bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" width="400" height="240" border="0"  style="border:1px solid #2906A2">
				<tr>
					<td align="center" height="75"><img src="../Template/Img/blank.jpg" border="0" ></td>
				</tr>
				<tr>
									...
									<table cellpadding="2" cellspacing="2" border="0">
										<tr>
											<td align="right" style="height: 23px">
                                                Usuário:&nbsp;</td>
											<td><asp:TextBox ID="txtLogin" runat="server" EnableViewState="False" onfocus="this.style.backgroundColor='#E8E8E8'; document.images['imgLogin'].src='../Template/Img/cadeado.gif'" onblur="this.style.backgroundColor='#FFFFFF'; document.images['imgLogin'].src='../Template/Img/blank.gif'" MaxLength="50" Width="170px"></asp:TextBox></td>
										...
										<tr>
											<td colspan="3" align="center"><asp:ImageButton ID="BtnLogar" runat="server" 
                                                    ImageUrl="../Template/Img/btnAcessar.gif" OnClick="BtnLogar_Click" /></td>
										</tr>
									</table>
                                </td>
							</tr>
