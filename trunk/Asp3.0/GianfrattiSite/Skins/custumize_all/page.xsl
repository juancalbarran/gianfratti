...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxml="urn:schemas-microsoft-com:xslt" xmlns:game="urn:schemas-cagle-com:game" version="1.0" exclude-result-prefixes="msxml game" xml:space="preserve">
	...
	<xsl:param name="body_background">#FF0000</xsl:param>			
	<xsl:param name="body_color">#000099</xsl:param>
	<xsl:param name="bodytext_color">#000000</xsl:param>
	
	<xsl:param name="toolbar_color">#FFFFFF</xsl:param>
	<xsl:param name="toolbar_background">#000099</xsl:param>
	...
	<xsl:param name="headertext_color">#0000ff</xsl:param>
	<xsl:param name="headerslogan_color">#0000ff</xsl:param>
	...
	<xsl:param name="main_border">#1</xsl:param>
	...
	<xsl:param name="footer_background">#000099</xsl:param>
	<xsl:param name="footer_color">#FFFFFFF</xsl:param>
		...
		<HTML dir="{$textdirection}" xmlns="http://www.w3.org/1999/xhtml">
			<HEAD>
				...
				<style>
					...
					A {	FONT-WEIGHT: normal; FONT-SIZE: 11px; COLOR: <xsl:value-of select="$link_color"/>; font-family: <xsl:value-of select="$general_font"/>}
					...
					A.toolbar:Hover { COLOR: <xsl:value-of select="$toolbar_highlight"/>; TEXT-DECORATION: none}
					...
					A.link:Hover { COLOR: <xsl:value-of select="$link_color"/>; font-size: 8pt; text-decoration:none}
					A.link	{ COLOR: <xsl:value-of select="$link_highlight"/>; font-size: 8pt; text-decoration:none }
		...
		<xsl:choose>
			...
			<xsl:otherwise>
				...
				<body  margin="0" bgcolor="{$page_background}">
					...
					<table border="{$main_border}" cellpadding="0" cellspacing="1" width="100%" align="center" height="500" bgcolor="{$main_background}">
						<tr valign="top">
							<br/>
				...
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0" style="border-top: 1px solid {$toolbar_border}; border-bottom: 1px solid {$toolbar_border};">
					<TR height="16"><TD bgColor="{$footer_background}" align="center"><font color="{$footer_color}"><xsl:call-template name="copyright_macro"/></font></TD></TR>
				</TABLE>	
				</body>
