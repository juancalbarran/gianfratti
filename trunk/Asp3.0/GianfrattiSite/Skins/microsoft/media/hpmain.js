...
var arrParts = new Array("HPFrame1", "HPFrame2", "HPFrame3", "HPFrame4", "HPFrame5", "HPFrame6", "HPFrame7", "HPFrame8", "HPFrame9", "HPFrame10");
var blnIE5    = false;
var blnBorder = false;
var blnTrack  = false;
var blnDebug  = false;
...
function loadPage(nthTrack,nthBorder)
{
	...
	if (blnIE5)
	{
		...
		{  
			...
			if (nthBorder > 0)
			{
				...
				{
					blnBorder = true;
					document.all("HPFrame1Content").style.borderColor = "#cccccc";
					document.all("HPFrame2Content").style.borderColor = "#cccccc";
				}
			}
		}
	}
	else
	{
		...
		{
			document.all('HPFrame1Tab3').src = "skins/microsoft/media/expand/collapse.gif";
			document.all('HPFrame2Tab3').src = "skins/microsoft/media/expand/collapse.gif";
		}
	}
}
...
function showHideContent(id,bOn)
{
	...
	if (bOn == false)
	{
		...
		oImage.src = "skins/microsoft/media/expand" + (bMO? "_mo.gif" : ".gif");
	}
	else
	{
		oContent.style.display = "";
		oImage.src = "skins/microsoft/media/collapse" + (bMO? "_mo.gif" : ".gif");
	}
...
function setBorder(id,bOn)
{
	...
	if (bOn)
	{
		...
		oTab.bgColor = "#3366CC";
		oTab1.src    = "skins/microsoft/media/curve_mo.gif";
		oTab2.color  = "#FFFFFF";
		if (oBorder.style.display == "none")
			oTab3.src = "skins/microsoft/media/expand_mo.gif";
		else
			oTab3.src = "skins/microsoft/media/collapse_mo.gif";
	}
	else
	{
		oBorder.style.borderColor = blnBorder? "#cccccc" : "#ffffff";
		oTab.bgColor = "#CCCCCC";
		oTab1.src	 = "skins/microsoft/media/curve.gif";
		oTab2.color  = "#336699";
		if (oBorder.style.display == "none")
			oTab3.src = "skins/microsoft/media/expand.gif";
		else
			oTab3.src = "skins/microsoft/media/collapse.gif";
	}
}
...
function trackInfoForm(param)
{
	if (blnTrack)
	{
		var sUrl = "skins/microsoft/media/dot.gif";
		...
		for (var j=0; j < arrParts.length; j++)
		{
			...
			{	
				...
				{   
					...
					oPartHolder = m_zoneElement.replaceChild( replacingDiv, holderDiv);

					oPart = m_zoneElement.replaceChild(	replacingnext, holdernext);
					oPartSpacer = m_zoneElement.replaceChild(replacingnextnext, holdernextnext);
					break outerloop;
				}
			}
		}
