...
<TABLE borderColor="#000000" cellSpacing="0" borderColorDark="#00000" cellPadding="0" width="100%" borderColorLight="#000000" border="0" background="skins/at/media/center.jpg">
  <TR><TD bgColor="#000000" height="1"><img src="admin/media/dot.gif" width="1" height="1"/></TD></TR>
		...
		<TR><TD><xsl:value-of select="$nbsp" disable-output-escaping="yes"/><b><font color="#264B99">
			<!-- start uneditable zone -->
			<xsl:choose>
				<xsl:when test="contains($title, '&lt;')"><xsl:value-of select="$title" disable-output-escaping="yes"/></xsl:when>
				<xsl:otherwise><xsl:copy-of select="$title" /></xsl:otherwise>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr> 
    ...
    <td width="100%" background="skins/at/media/center.jpg" ><xsl:value-of select="$nbsp" disable-output-escaping="yes"/> <font color="#264B99"><b> 
      <!-- start uneditable zone -->
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr> 
    ...
    <td class="rub" width="100%" background="skins/at/media/center.jpg" ><xsl:value-of select="$nbsp" disable-output-escaping="yes"/> 
      <font color="#264B99"><b> 
      <!-- start uneditable zone -->
      <xsl:choose> <xsl:when test="contains($title, '&lt;')"><xsl:value-of select="$title" disable-output-escaping="yes"/></xsl:when> 
      <xsl:otherwise><xsl:copy-of select="$title" /></xsl:otherwise> </xsl:choose> 
...
<TABLE cellSpacing="0" borderColorDark="#00000" cellPadding="0" width="100%" borderColorLight="#000000" border="0" background="skins/at/media/center.jpg">
  <TR><TD height="1"><img src="admin/media/dot.gif" width="1" height="1"/></TD></TR>
		<TR><TD><img src="admin/media/dot.gif" width="1" height="4"/></TD></TR>
		<TR>
    <TD align="right"><font color="#264B99"><xsl:value-of select="$nbsp" disable-output-escaping="yes"/><xsl:call-template name="toolbar_body_macro"/></font></TD>
  </TR>
		<TR><TD><img src="admin/media/dot.gif" width="1" height="4"/></TD></TR>
		<TR><TD height="1"><img src="admin/media/dot.gif" width="1" height="1"/></TD></TR></TABLE>				
	</xsl:template>	
