...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template name="sitetile_design">
		...
		<table><tr><td style="width:100%; color:#C0C000; filter:dropshadow(color=#000000, offX=1, offY=1)"><font face="verdana" size="5" color="#264B99"><b><i><xsl:copy-of select="$title" /></i></b></font></td></tr></table>
...
<TABLE cellSpacing="0" cellPadding="0" width="100%"  border="0">
  <TR>
    <TD height="1" colspan="3"><img src="admin/media/dot.gif" width="1" height="1"/></TD>
  </TR>
  <TR>
    <TD colspan="3"><img src="admin/media/dot.gif" width="1" height="2"/></TD>
  </TR>
  <TR>
    <TD width="20" background="skins/kst/media/smlt.jpg"></TD>
    <TD><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
          <td background="skins/kst/media/smcenter.jpg" height="15"><xsl:value-of select="$nbsp" disable-output-escaping="yes"/><b><font color="#264B99"> 
            <!-- start uneditable zone -->
    ...
    <TD width="30" background="skins/kst/media/smrt.jpg"></TD>
  </TR>
  <TR>
    <TD colspan="3"><img src="admin/media/dot.gif" width="1" height="2"/></TD>
  </TR>
...
<table border="0" cellspacing="0" cellpadding="0" bgcolor="#d7d7d7">
  ...
  <tr>
    <td bgcolor="#FFFFFF"> 
      <!-- start uneditable zone -->
      <xsl:choose> <xsl:when test="contains($text, '&lt;')"><xsl:value-of select="$text" disable-output-escaping="yes"/></xsl:when> 
      <xsl:otherwise><xsl:copy-of select="$text" /></xsl:otherwise> </xsl:choose> 
      <!-- end uneditable zone -->
    </td>
  </tr></table>	
	</td>
...
<table border="0" cellpadding="0" cellspacing="0" width="145">
  <tr> 
    <td width="5" background="skins/kst/media/smlt.jpg"></td>
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td background="skins/kst/media/smcenter.jpg" height="15"><xsl:value-of select="$nbsp" disable-output-escaping="yes"/> <font color="#264B99"><b> 
            <!-- start uneditable zone -->
            <xsl:choose> <xsl:when test="contains($title, '&lt;')"><xsl:value-of select="$title" disable-output-escaping="yes"/></xsl:when> 
            <xsl:otherwise><xsl:copy-of select="$title" /></xsl:otherwise> </xsl:choose> 
            <!-- end uneditable zone -->
    ...
    <td background="skins/kst/media/smrt.jpg" width="20%"> 
      <div align="right"></div>
    </td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
...
<table border="0" cellpadding="0" cellspacing="0" width="145">
  <tr> 
    <td class="rub" width="15%" background="skins/kst/media/smlt.jpg" ></td>
    <td class="rub" >
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
          <td background="skins/kst/media/smcenter.jpg" height="15"><xsl:value-of select="$nbsp" disable-output-escaping="yes"/> <font color="#264B99"><b> 
    ...
    <td class="rub" width="21%" background="skins/kst/media/smrt.jpg" ></td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
  ...
  <tr> 
    <td width="100%" colspan="4"> 
      <div align="center">
        <table width="90%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FF9900">
          <tr>
            <td>
              <table width="100%" border="0" cellspacing="1" cellpadding="4">
                <tr>
                  <td bgcolor="#FFFFFF"><!-- start uneditable zone -->
      <xsl:choose> <xsl:when test="contains($body, '&lt;')"><xsl:value-of select="$body" disable-output-escaping="yes"/></xsl:when> 
...
<TABLE cellSpacing="0" borderColorDark="#00000" cellPadding="0" width="100%" borderColorLight="#000000" border="0">
  <TR>
    <TD height="1" colspan="3"><img src="admin/media/dot.gif" width="1" height="1"/></TD>
  </TR>
  <TR>
    <TD colspan="3"><img src="admin/media/dot.gif" width="1" height="4"/></TD>
  </TR>
  <TR> 
    <TD background="skins/kst/media/edlt.jpg" width="30"></TD>
    <TD background="skins/kst/media/center.jpg" height="25"><font color="#264B99"><xsl:value-of select="$nbsp" disable-output-escaping="yes"/><xsl:call-template name="toolbar_body_macro"/></font></TD>
    <TD background="skins/kst/media/edrt.jpg" width="30"></TD>
  </TR>
  <TR>
    <TD colspan="3"><img src="admin/media/dot.gif" width="1" height="4"/></TD>
  </TR>
