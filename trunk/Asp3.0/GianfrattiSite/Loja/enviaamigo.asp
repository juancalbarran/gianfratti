...
if request.querystring("acao") = "abre" then%>
   					<table><form action="enviaamigo.asp?acao=cadastra" method="post"><input type=hidden name=produto value="<%=produto%>"><tr><td width=130><font style=font-size:11px;font-family:tahoma,arial,helvetica;color:000000>Nome do seu amigo:</td><td><input name="nomeamigo" type="text"  style=font-size:11px;font-family:tahoma,arial,helvetica;color:000000></td></tr>
					  <tr><td width=130><font style=font-size:11px;font-family:tahoma,arial,helvetica;color:000000>E-mail do seu amigo:</td><td><input name="emailamigo" type="text" style=font-size:11px;font-family:tahoma,arial,helvetica;color:000000></td></tr>
					  <tr><td width=130><font style=font-size:11px;font-family:tahoma,arial,helvetica;color:000000>Seu nome:</td><td><input name="nome" type="text" style=font-size:11px;font-family:tahoma,arial,helvetica;color:000000 value="<%=nomez%>"></td></tr>
					  ...
					  <tr><td colspan="2"><table border=0 cellspacing=0 width=100% cellpadding=0><tr><td height=5></td></tr><tr><td height=1 bgcolor=<%=cor3%>></td></tr><tr><td height=5></td></tr></table></td></tr><tr><td colspan="2"align=center><input type="image" src="<%=dirlingua%>/imagens/env_oferta.gif" border="0"></td></tr></form>
					</table>
<%
end if
...
strMensagem = strMensagem & "      <br><b>"&_
"<a href='http://"& urlloja&"/produtos.asp?produto="&produto&"' target=_new><font style=font-size:11px>Visualizar sua oferta!</a></b></font>"
strMensagem = strMensagem & "      <table border=0 cellspacing=0 width=100% cellpadding=0><tr><td height=5></td></tr><tr><td height=1 bgcolor="&cor3&"></td></tr><tr><td height=5></td></tr></table>"
