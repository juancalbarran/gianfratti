...
set dados = Nothing%>
					 ...
					 <tr><td><font style=font-family:<%=fonte%>;font-size:11px;color:#000000;><%=strLg118%></font></td><td><input type=text size=40 name=nomecompleto style=font-family:<%=fonte%>;font-size:11px;color:#000000; value="<%=strNome%>" maxlength="30"></td></tr>
...
<%else%>
   		  			  <select style=font-family:<%=fonte%>;font-size:11px;color:#000000; name="estado"> <option select value="<%=strEstado%>"><%=strEstado%> <option select value="">--- <option value="AC">AC<option value="AL">AL<option value="AM">AM<option value="AP">AP<option value="BA">BA<option value="CE">CE<option value="DF">DF<option value="ES">ES<option value="GO">GO<option value="MA">MA<option value="MG">MG<option value="MS">MS<option value="MT">MT<option value="PA">PA<option value="PB">PB<option value="PE">PE<option value="PI">PI<option value="PR">PR<option value="RJ">RJ<option value="RN">RN<option value="RO">RO<option value="RR">RR<option value="RS">RS<option value="SC">SC<option value="SE">SE<option value="SP">SP<option value="TO">TO</option></select><font face="<%=fonte%>" style=font-family:<%=fonte%>;font-size:11px;color:#000000;><input type="checkbox" name="outropais" value="Sim" onclick="javascript: paises();">Outro País</font></td></tr><tr><td><font style=font-family:<%=fonte%>;font-size:11px;color:#000000;>CEP:</font></td><td><input type=text size=13 name=cepzz style=font-family:<%=fonte%>;font-size:11px;color:#000000; value="<%=strCep%>"></td></tr
<%end if%>
					  ...
					  <option value="<%= strPais %>" select><%= strPais %></option><option value="">-----------------------------------------</option><option value="Brasil">Brasil</option><option value="Afeganistão">Afeganistão</option><option value="África do Sul">África do Sul</option><option value="Aland - Finlândia">Aland - Finlândia</option><option value="Albânia">Albânia</option><option value="Alemanha">Alemanha</option><option value="Andorra">Andorra</option><option value="Angola">Angola</option><option value="Anguilla - Reino Unido">Anguilla - Reino Unido</option><option value="Antártida">Antártida</option><option value="Antígua e Barbuda">Antígua e Barbuda</option><option value="Antilhas Holandesa">Antilhas Holandesas</option><option value="Arábia Saudita">Arábia Saudita</option><option value="Argélia">Argélia</option><option value="Argentina">Argentina</option><option value="Armênia">Armênia</option><option value="Aruba - Holanda">Aruba - Holanda</option><option value="Ascensão - Reino Unido">Ascensão - Reino Unido</option><option value="Austrália">Austrália</option><option value="Áustria">Áustria</option><option value="Azerbaijão">Azerbaijão</option><option value="Bahamas">Bahamas</option><option value="Bahrein">Bahrein</option><option value="Bangladesh">Bangladesh</option><option value="Barbados">Barbados</option><option value="Belarus">Belarus</option><option value="Bélgica">Bélgica</option><option value="Belize">Belize</option><option value="Benin">Benin</option><option value="Bermudas - Reino Unido">Bermudas - Reino Unido</option><option value="Bioko - Guiné Equatorial">Bioko - Guiné Equatorial</option>
					  ...
					  <tr><td><font style=font-family:<%=fonte%>;font-size:11px;color:#000000;><%=strLg109%></font></td><td><input type=text size=15 name=fone style=font-family:<%=fonte%>;font-size:11px;color:#000000; value="<%=strFone%>"><font style=font-family:<%=fonte%>;font-size:9px;color:#000000;></font></td></tr>
									 ...
									 <tr><td><font style=font-family:<%=fonte%>;font-size:11px;color:#000000;><%=strLg291%></td><td><input type=text size=20 name=contato style=font-family:<%=fonte%>;font-size:11px;color:#000000; value="<%=strContato%>" maxlength="50"> <font style=font-family:<%=fonte%>;font-size:9px;color:#000000;></td></tr>
