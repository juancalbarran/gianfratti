...
'#  // considerado Open-source(gratuito) e o uso sem autorização terá 7
	...
	'Inicia a primeira coluna%>
	  ...
	  <%  If len(cstr(impequeno))<3 then impeq="img_nao_disp.gif" else impeq=impequeno end if%>
	  		  		<tr><td>
							...
							<table align=center width=260 cellspacing="1" cellpadding="1"><tr><td width=80 height=100><a href="produtos.asp?produto=<%=rs("idprod")%>"  onMouseOut="window.status='';return true;" onMouseOver="window.status='<%=strLg30%>';return true;" style="color:#FFFFFF;text-decoration:none;"><img src="produtos/<%=impeq%>"  border="0"></a></td><td valign=center width=200><font style=font-size:11px;font-family:<%=fonte%>><b><font color=000000><%=rs("nome")%></b><br><br><b><%=strLg29%></b>&nbsp;<%= strlgMoeda & " " & precito%>
	...
	%>
	 ...
	 <%  If len(cstr(impequeno2))<3 then impeq="img_nao_disp.gif" else impeq=impequeno2 end if%>
	  		  		<tr><td>
						    ...
						    <table align=center width=260 cellspacing="1" cellpadding="1"><tr><td width=80 height=100><a href="produtos.asp?produto=<%=rs3("idprod")%>"  onMouseOut="window.status='';return true;" onMouseOver="window.status='<%=strLg30%>';return true;" style="color:#FFFFFF;text-decoration:none;"><img src="produtos/<%=impeq%>"  border="0"></a></td><td valign=center width=200><font style=font-size:11px;font-family:<%=fonte%>><b><font color=000000><%=rs3("nome")%></b><br><br><b><%=strLg29%></b>&nbsp;<%=strlgMoeda & " " & precito2%>
...
<table BORDER="0" CELLSPACING="1" CELLPADDING="3"><tr><td bgcolor=#ffffff>
<form action="comprar.asp" method="post" name=comprar<%=rs("idprod")%>>
<table align=center width=260 cellspacing="1" cellpadding="1"><tr><td width=80 height=120><a href="produtos.asp?produto=<%=rs("idprod")%>"  onMouseOut="window.status='';return true;" onMouseOver="window.status='<%=strLg30%>';return true;" style="color:#FFFFFF;text-decoration:none;"><img src="produtos/<%=impeq%>"  border="0"></a></td>
<td valign=center width=200><font style=font-size:11px;font-family:<%=fonte%>><b><font color=000000><%=rs("nome")%></b><br><br><b><%=strLg29%></b>&nbsp;<%=strLgMoeda & " " & precito%>
