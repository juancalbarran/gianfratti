...
-->
				   ...
				   <div id="Layer1">
				     <div align="center"><b><%=(strLg12)%></b></div>
				   </div>
				   <div id="Layer2"><span style="BACKGROUND: #ff0000 ; HEIGHT: 22px"><b><font color="#FFFFFF"><%=strLg14%></font></b></span></div>
...
<TABLE width="100%" border=0 align="center" cellPadding=0 cellSpacing=0 bgColor=#f0f0f0>
  ...
  <TR>
    ...
    <TD><IMG height=40 src="<%= dirlingua %>/imagens/spacer.gif" width=5></TD>
        ...
        <TR>
          <TD height="178" valign="top">
            ...
            <TABLE style="BORDER-RIGHT: #bbbaba 1px solid; BORDER-TOP: #bbbaba 1px solid; BORDER-LEFT: #bbbaba 1px solid; BORDER-BOTTOM: #bbbaba 1px solid; HEIGHT: 24px" cellSpacing=0 cellPadding=0 width="100%" align=center  border=0>
              <TBODY>
              <TR>
                <TD height="42" align="left" valign="top"><img src="linguagens/portuguesbr/imagens/menudep.jpg" width="159" height="42" /></TD>
            </TR>
              <TR>
                <TD height="123" align="left" valign="top"><table width="159" 
            ...
            <TABLE cellSpacing=0 cellPadding=0 width=160 border=0 >
             ...
             <p><IMG height=10 src="<%= dirlingua %>/imagens/spacer.gif" width=1>
               ...
               <!-- /////    Quadro Atendimento Online - Lateral Esquerdo  -->
                      <iframe name="SOS_status" src="http://www.megametropole.com.br/loja/chat/status.asp" style="width:150;height:90" scrolling="no" frameborder="0"></iframe>
               <BR>
               <%
'nn= Server.CreateObject("adodb.connection")
'Conn.open  "Provider=Microsoft.Jet.OLEDB.4.0;Data Source="& Server.MapPath("chat/databases/SOSdatabase.mdb") 
'--------------------------------------------------------------------------------------------------      
'SQl = "select * from atendentes where status = '0'"
...
'--------------------------------------------------------------------------------------------------
	...
	'	Response.Write " <img src="&dirlingua&"/imagens/atend_on.gif onclick=""javascript:generico('chat/usuario_entrar.asp','aol',400,400,20,20,'no','no')""  border=0 style=""cursor:hand"" onMouseOut=""window.status='';return true;"" onMouseOver=""window.status='"&strLg258&"';return true;""><BR><br><br>"
	'else
...
'set atend = nothing%>
               ...
               <br>
               <br>
               <img src="linguagens/portuguesbr/imagens/skype.jpg" width="160" height="68" /><br>
               <br>
