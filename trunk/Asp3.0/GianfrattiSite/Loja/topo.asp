...
'*** Se for a tela final de compra (pagamento.asp) tb, pois aparecia o menu errado (pois era encerrado a 'sessao' na tela final de compra apos jÃƒÆ’Ã‚Â¡ ter aparecido o menu de 'logado') 
%>	
...
<TABLE width="100%" height="54" border=0 cellPadding=0 cellSpacing=0 bgColor=#f0f0f0>
  ...
  <TR>
    ...
    <TD align=left width="40%"><IMG 
      src="<%=dirlingua%>/imagens/disque_loja.gif" border=0></TD>
    <TD><IMG height=32 src="<%= dirlingua %>/imagens/spacer.gif" width=5></TD>
...
<table cellspacing="0" cellpadding="0" width="161" border="0">
  <tbody>
    <tr>
      <td colspan="3" valign="top"><img src="<%=dirlingua%>/imagens/menudep.jpg" /></td>
    </tr>
    <tr>
...
<table cellspacing="0" cellpadding="0" width="160" border="0" >
  <tr>
    <td style="BACKGROUND: <%= Cor_principal %>; HEIGHT: 22px" colspan="3"><img src="<%=dirlingua%>/imagens/menuorca.gif" /></td>
  </tr>
  <tr>
    <td></TBODY></td>
  </tr>
...
<table cellspacing="0" cellpadding="2" width="160" border="0" bgcolor="#ffffff" style="BACKGROUND: #ffffff; BORDER-LEFT: #bbbaba 1px solid; BORDER-RIGHT: #bbbaba 1px solid; BORDER-BOTTOM: #bbbaba 1px solid">
  ...
  <tr>
    <td class="ti"><img alt="Blue Arrow" 
                        src="<%= dirlingua %>/imagens/arrow_blue.gif" 
                        border="0" />&nbsp;<a class="bbh" 
                        href="cotacaocesta.asp"><%=strLg326%></a></td>
  </tr>
...
<!-- /////     Quadro Atendimento - Lateral Esquerdo  -->
            ...
            <TABLE cellSpacing=0 cellPadding=0 width=160 border=0 >
                   <TR><TD style="BACKGROUND: <%= Cor_principal %>; HEIGHT: 22px" colSpan=3><img src="<%=dirlingua%>/imagens/menudep1.jpg" /></TD>
                   </TR>
                   </TBODY></TABLE>
	 ...
	 If InStr(Request.ServerVariables("SCRIPT_NAME"),"pagamento.asp") = 0 then %>
      ...
      <p><IMG height=10 src="<%= dirlingua %>/imagens/spacer.gif" width=1>
               ...
               <!-- /////    Quadro Atendimento Online - Lateral Esquerdo  -->
					...
					<iframe src="atendimento/base/mysStatus.asp" name="atendimento" width="165" marginwidth="0" height="90" marginheight="0" align="middle" scrolling="No" frameborder="0" hspace="0" vspace="0" id="atendimento"  application="true"></iframe>
        ...
        <a href="callto:loja"><img src="<%=dirlingua%>/imagens/skype.jpg" border="0" /></a><br>			
      </p>
...
&nbsp;&nbsp;&nbsp;&nbsp;<IMG align="absmiddle" src="<%= dirlingua %>/imagens/motoboy.gif"  border=0 ></p>
             <p align="left"><img src="<%=dirlingua%>/imagens/selo_seguro.gif" /></p>
             <p align="left"><img src="<%=dirlingua%>/imagens/logo_internetsegura.gif" /> <img src="<%=dirlingua%>/imagens/detalhe_produto_compra_segura.gif" /><br>
               <br />
