...
<title>AdMentor: Add New Farm</title>
<style type="text/css">
<!--
                      ...
                      <td align="left" height="100%" vAlign="top" width="65%">
                        ...
                        <table border="0" width="100%">
                          <tr>
                            ...
                            <td>                       <form method="POST" action="savefarm.asp">
                        ...
                        <table border="0" width="100%" cellpadding="2" bgcolor="#ffffff">
                          <tr>
                            ...
                            <tr>
                            <td width="39%"><b>Descrição</b>:</td>
                            <td width="61%"><input type="text" name="description" size="30"></td>
                            </tr>
								 <tr>
								 <td colspan="2"><p><input type="submit" value="Submit" name="B1"><input type="reset" value="Reset" name="B2"></p></td>
								</tr>
                            </table>
                            </td></tr></table>
                                </form>
