...
End If
	...
	If Request.QueryString("del") = "yes" Then
		If g_AdMentor_Demo = False Then
			oConn.Execute "delete from zone where zoneid=" & Request.QueryString("id") 
   	 	End If
    	Response.Redirect "adminzones.asp"
	End if

	
    Set oRS = oConn.Execute("select zoneid, zonename, descr from zone where zoneid = " & Request.QueryString("id") )
...
<title>Administrate Zones</title>
<style type="text/css">
<!--
                    ...
                    <tr>
                      <td align="left" height="100%" vAlign="top" width="65%">
                        <table border="0" width="100%">
                          <tr>
                            <td width="50%" valign="middle" align="left"><font color="#aa3333" face="Arial, Geneva, Helvetica, Verdana" size="4"><b>Atenção: Excluir a Categoria <%=oRS("zonename").Value%>??</b></font>
                            </td>
                        ...
                        <p align="center">Você solicitou a exclusão da categoria <%=oRS("zonename").Value%>. Voce tem certeza? 
					<p align="center">
                     
                        <%WriteFakeButton "deleteazone.asp?id=" & oRS("zoneid").Value & "&del=yes", "Sim, tenho certeza" %>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <%WriteFakeButton "adminzones.asp", "Não!"
                        %>
                        </p>
                        ...
                        <table border="0" width="100%">
                          <tr>
                            <td width="50%"><%If g_AdMentor_Demo = True Then 
