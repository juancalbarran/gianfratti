...
End If
    ...
    Set oRS = oConn.Execute("select  zoneid, zonename, descr from zone")
%>
                        ...
                        <table border="0" width="100%">
                          <tr>
                            <td width="50%" valign="middle" align="left"><font color="#aa3333" face="Arial, Geneva, Helvetica, Verdana" size="4"><b>Administração
                              de Categorias</b></font>
                            </td>
                            <td width="50%" valign="middle" align="right">
                            <%If Session("admin") = True Then %>
                            <%WriteFakeButton "addazone.asp", "Adicionar Categoria"%>
                            <%End If%>  
                            </td>
                          </tr>
                        </table>
...
Dim strEdit, strDel
	While Not oRS.EOF
	strEdit = "adminazone.asp?id=" & oRS("zoneid")
	strDel = "deleteazone.asp?id=" & oRS("zoneid")
%>

                          <tr>
                            <td bgcolor="#ffffff"><%=oRS("zonename")%></td>
                            <td bgcolor="#ffffff"><%=oRS("descr")%></td>
                            <td bgcolor="#ffffff"><%WriteFakeButton strDel, "Excluir"%>
                            </td>
                          </tr>
<%
	oRS.MoveNext
