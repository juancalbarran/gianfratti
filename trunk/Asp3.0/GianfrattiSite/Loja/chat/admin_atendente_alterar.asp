...
If Not IsEmpty(Request.Form("salvar")) Then
  ...
  If indice <> "" Then strQ = " SELECT * FROM atendentes WHERE " & indice
  ...
  Set objCon = Nothing
%>
<B><font color="#CC0000">Cadastro alterado</font></B><BR>
Os dados do atendente foram alterado com sucesso.<BR>
<BR>
<%
Else
  ...
  If indice = "" Then objRS.Move Request.Form("recordno") - 1
%>
<B><font color="#CC0000">Alterar dados do Atendente</font></B><BR>
Altere os dados necessários do atendente abaixo:<BR>
