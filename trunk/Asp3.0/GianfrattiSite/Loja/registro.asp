...
<a href="busca_cep.asp" target="novocep" onclick="window.open('','novocep','width=400,height=400,resizable=yes,scrollbars=yes')"><font face="<%=fonte%>" style=font-size:11px;color:000000><u>Não sabe seu CEP?</u></font></a></td></tr>
