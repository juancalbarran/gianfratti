...
//Este if foi feito porque o tamanho do meu do Funcionario é diferente do tamanho do menu do cliente
//Foi criado um form na pagina menu.asp e uma campo hidden com o tamanho do comprimento do menu
var comprimento_menu
if (document.form_menu.Menu_Comprimento.value != ""){comprimento_menu = document.form_menu.Menu_Comprimento.value }
else{comprimento_menu = 300}

//var height = 275; //Estava 325 Referente ao comprimento do MENU
var height = comprimento_menu; //Estava 325 Referente ao comprimento do MENU
var vwidth = 145; //Referente a largura do MENU
var speed = 0;
var step =7;//Velocidade que abre o menu quando clica no item

var hheight = 21; // heigth of a header item   Tamanho do cabelhaço do menu
var iheight = 15; // heigth of a item  Distancia entre os links do menu

var bgc = "#F0F0F0" // background color of the item
