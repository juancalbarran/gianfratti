<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Resultados_Exames.aspx.vb" Inherits="SmartCare.Resultados_Exames"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Resultados_Exames</title>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			&nbsp;&nbsp;
			<FIELDSET id="FIELDSET1" style="WIDTH: 100%; HEIGHT: 30px"><LEGEND id="LEGEND1" align="center" runat="server">&nbsp;Resultado 
					de Exames&nbsp;</LEGEND>
				<TABLE id="Tbl_DataGrid" cellSpacing="0" cellPadding="0" width="100%" border="0" runat="server">
					...
					<TR>
						<TD colSpan="3">
							<asp:datagrid id="MyDataGrid" runat="server" AllowPaging="True" AllowSorting="True" PageSize="20"
								AutoGenerateColumns="False" CellPadding="4" BackColor="White" BorderWidth="1px" BorderStyle="None"
								BorderColor="#3366CC" Width="100%">
					...
					<TR>
						<TD colSpan="3">
							<TABLE id="Table3" width="100%">
								...
								<TR class="zebra_orange1">
									<TD>
										<asp:label id="Lbl_id_Atendimento" runat="server"></asp:label></TD>
									<TD>
										<asp:label id="Lbl_Paciente" runat="server"></asp:label></TD>
									<TD>
										<asp:label id="Lbl_Convenio" runat="server"></asp:label></TD>
								</TR>
							</TABLE>
							<TABLE id="Table4" width="100%">
								...
								<TR class="zebra_orange1">
									<TD>
										<asp:label id="Lbl_Sexo" runat="server"></asp:label></TD>
									<TD>
										<asp:label id="Lbl_Idade" runat="server"></asp:label></TD>
									<TD>
										<asp:label id="Lbl_Material" runat="server"></asp:label></TD>
									<TD>
										<asp:label id="Lbl_Coleta" runat="server"></asp:label></TD>
								</TR>
								<TR class="zebra_orange1">
								...
								<TR class="zebra_orange1">
									<TD colSpan="4">
										<asp:label id="Lbl_InfoClinicas" runat="server"></asp:label></TD>
								</TR>
							</TABLE>
							<TABLE id="Table5" width="100%">
								...
								<TR class="zebra_orange1">
									<TD class="texto">
										<asp:datagrid id="Dtg_Exames" runat="server" Width="100%" BorderColor="#3366CC" BorderStyle="None"
											BorderWidth="1px" BackColor="White" CellPadding="4" AutoGenerateColumns="False" PageSize="20"
											...
											<Columns>
												...
												<asp:EditCommandColumn ButtonType="LinkButton" UpdateText="Update" CancelText="Cancel" EditText="Enviar resultado"></asp:EditCommandColumn>
											</Columns>
											<PagerStyle HorizontalAlign="Left" ForeColor="#003399" BackColor="#99CCCC" Mode="NumericPages"></PagerStyle>
										</asp:datagrid></TD>
								</TR>
							...
							<TABLE id="Table6" width="100%">
								...
								<TR class="zebra_orange1">
									<TD>
										<asp:label id="Lbl_DtEmissao" runat="server"></asp:label></TD>
									<TD>
										<asp:label id="Lbl_Med_Solicitante" runat="server"></asp:label></TD>
									<TD>
										<asp:label id="Lbl_CRM" runat="server"></asp:label></TD>
									<TD>
										<asp:label id="Lbl_Coletor" runat="server"></asp:label></TD>
									<TD>
										<asp:label id="Lbl_Coleta_Dt" runat="server"></asp:label></TD>
									<TD>
										<asp:label id="Lbl_Hora" runat="server"></asp:label></TD>
								</TR>
							</TABLE>
							<asp:button id="Btn_Cancelar" runat="server" Text="Voltar"></asp:button></TD>
					</TR>
				</TABLE>
				<TABLE id="Tbl_Upload" width="100%" runat="server">
					<tr>
						<TD colSpan="2">sddfdfds</TD>
					</tr>
					<TR>
						<TD><INPUT id="TextBoxImg_Grande" style="WIDTH: 440px; HEIGHT: 22px" type="file" size="54"
								name="filUpload" runat="server"><INPUT id="Hidden_Id_Exame" type="hidden" value="34" name="Hidden1" runat="server"></TD>
						<TD>
							<asp:Button id="Button1" runat="server" Text="Enviar"></asp:Button></TD>
					</TR>
				</TABLE>
			</FIELDSET>
		</form>
