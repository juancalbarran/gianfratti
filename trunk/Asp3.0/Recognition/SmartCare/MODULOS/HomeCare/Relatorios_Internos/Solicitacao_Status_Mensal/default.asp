...
' Data: 12/01/2006
' Descrição: Pagina de relatorio de mensal de solicitacao por status
' Atualizado por: -
' Data: -
' Atualização: -
%>
...
Function Visualizar
	...
	SQL	=	"EXEC Relatorio_Solicitacao_Status_Mensal '"&Request("Ano")&"' "
...
select case useraction
	...
	Case Else
%>
	<!-- #include virtual="/SmartCare/Modulos/HomeCare/Relatorios_Internos/Solicitacao_Status_Mensal/modelos/Form_Visualizar.htm" -->
<%
End Select
