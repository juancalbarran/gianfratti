...
' Data: 12/01/2006
' Descrição: Pagina de relatorio de solicitações mensal do convenio
' Atualizado por: -
' Data: -
' Atualização: -
%>
...
Function Visualizar
	...
	SQL	=	"EXEC Relatorio_Convenio_Solicitacao_Mensal '"&Request("Ano")&"' "
...
select case useraction
	...
	Case Else
%>
	<!-- #include virtual="/SmartCare/Modulos/HomeCare/Relatorios_Internos/Convenios_Solicitacao_Mensal/modelos/Form_Visualizar.htm" -->
<%
End Select
