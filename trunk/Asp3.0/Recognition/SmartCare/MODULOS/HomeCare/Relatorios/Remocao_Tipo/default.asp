...
' Data: 12/01/2006
' Descrição: Pagina de relatorio de tipo de remoção
' Atualizado por: -
' Data: -
' Atualização: -
%>
...
Function Visualizar
	...
	SQL	=	"SELECT id, Descricao, "&_ 
				"(SELECT COUNT(id_Solicitacao_Remocao_Tipo) "&_ 
				"FROM dbo.HomeCare_Solicitacao_Atendimento "&_ 
				"WHERE id_Solicitacao_Remocao_Tipo = dbo.HomeCare_Solicitacao_Remocao_Tipo.id AND (id_Convenio = '"&Session("id_Convenio")&"')) AS Total "&_ 
			"FROM dbo.HomeCare_Solicitacao_Remocao_Tipo "
				...
				If Not Rs.Eof Then
					Response.Write "<table width='100%' border='0' cellspacing='0' cellpadding='0' class='borda' >" & Chr(10)
						Response.Write "<Tr class='Titulo_Tabela'>" & Chr(10)
							Response.Write "<Td>Tipo de Remoção</Td>" & Chr(10)
